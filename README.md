...
- **F1 (macro):** 1.00 (на сбалансированном тестовом наборе)
- **Accuracy:** 1.00
...
*Примечание: Высокие метрики обучены на небольшом демонстрационном датасете. Анализ ошибок в `error_analysis.txt` показывает, что модель может ошибаться на саркастичных или нейтрально-окрашенных фразах.*
